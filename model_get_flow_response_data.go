...
// checks if the GetFlowResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFlowResponseData{}

// GetFlowResponseData struct for GetFlowResponseData
type GetFlowResponseData struct {
	Type FlowEnum `json:"type"`
	Id string `json:"id"`
	Attributes FlowResponseObjectResourceAttributes `json:"attributes"`
	Links ObjectLinks `json:"links"`
	Relationships *GetFlowResponseDataAllOfRelationships `json:"relationships,omitempty"`
}

type _GetFlowResponseData GetFlowResponseData
...
func (o *GetFlowResponseData) GetRelationships() GetFlowResponseDataAllOfRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret GetFlowResponseDataAllOfRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given GetFlowResponseDataAllOfRelationships and assigns it to the Relationships field.
func (o *GetFlowResponseData) SetRelationships(v GetFlowResponseDataAllOfRelationships) {
	o.Relationships = &v
}

func (o GetFlowResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetFlowResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *GetFlowResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetFlowResponseData := _GetFlowResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetFlowResponseData)

	if err != nil {
		return err
	}

	*o = GetFlowResponseData(varGetFlowResponseData)

	return err
}

type NullableGetFlowResponseData struct {
	value *GetFlowResponseData
	isSet bool
}

func (v NullableGetFlowResponseData) Get() *GetFlowResponseData {
	return v.value
}

func (v *NullableGetFlowResponseData) Set(val *GetFlowResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFlowResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFlowResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFlowResponseData(val *GetFlowResponseData) *NullableGetFlowResponseData {
	return &NullableGetFlowResponseData{value: val, isSet: true}
}

func (v NullableGetFlowResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFlowResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
