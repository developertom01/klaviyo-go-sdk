...
// checks if the CatalogItemUpdateJobResponseObjectResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogItemUpdateJobResponseObjectResource{}

// CatalogItemUpdateJobResponseObjectResource struct for CatalogItemUpdateJobResponseObjectResource
...
type _CatalogItemUpdateJobResponseObjectResource CatalogItemUpdateJobResponseObjectResource
...
func NewCatalogItemUpdateJobResponseObjectResource(type_ CatalogItemBulkUpdateJobEnum, id string, attributes CouponCodeCreateJobResponseObjectResourceAttributes, links ObjectLinks) *CatalogItemUpdateJobResponseObjectResource {
	this := CatalogItemUpdateJobResponseObjectResource{}
	this.Type = type_
	this.Id = id
...
func (o CatalogItemUpdateJobResponseObjectResource) MarshalJSON() ([]byte, error) {
...
func (o CatalogItemUpdateJobResponseObjectResource) ToMap() (map[string]interface{}, error) {
...
func (o *CatalogItemUpdateJobResponseObjectResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogItemUpdateJobResponseObjectResource := _CatalogItemUpdateJobResponseObjectResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogItemUpdateJobResponseObjectResource)

	if err != nil {
		return err
	}

	*o = CatalogItemUpdateJobResponseObjectResource(varCatalogItemUpdateJobResponseObjectResource)

	return err
}

type NullableCatalogItemUpdateJobResponseObjectResource struct {
	value *CatalogItemUpdateJobResponseObjectResource
	isSet bool
}

func (v NullableCatalogItemUpdateJobResponseObjectResource) Get() *CatalogItemUpdateJobResponseObjectResource {
	return v.value
}

func (v *NullableCatalogItemUpdateJobResponseObjectResource) Set(val *CatalogItemUpdateJobResponseObjectResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogItemUpdateJobResponseObjectResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogItemUpdateJobResponseObjectResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogItemUpdateJobResponseObjectResource(val *CatalogItemUpdateJobResponseObjectResource) *NullableCatalogItemUpdateJobResponseObjectResource {
	return &NullableCatalogItemUpdateJobResponseObjectResource{value: val, isSet: true}
}

func (v NullableCatalogItemUpdateJobResponseObjectResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogItemUpdateJobResponseObjectResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
