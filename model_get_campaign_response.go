...
// GetCampaignResponse struct for GetCampaignResponse
type GetCampaignResponse struct {
	Data GetCampaignResponseData `json:"data"`
}

type _GetCampaignResponse GetCampaignResponse
...
func (o *GetCampaignResponse) GetData() GetCampaignResponseData {
	if o == nil {
		var ret GetCampaignResponseData
		return ret
	}
...
func (o *GetCampaignResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCampaignResponse := _GetCampaignResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCampaignResponse)

	if err != nil {
		return err
	}

	*o = GetCampaignResponse(varGetCampaignResponse)
