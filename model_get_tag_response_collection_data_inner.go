...
// checks if the GetTagResponseCollectionDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTagResponseCollectionDataInner{}

// GetTagResponseCollectionDataInner struct for GetTagResponseCollectionDataInner
type GetTagResponseCollectionDataInner struct {
	Type TagEnum `json:"type"`
	// The Tag ID
	Id string `json:"id"`
	Attributes TagResponseObjectResourceAttributes `json:"attributes"`
	Links ObjectLinks `json:"links"`
	Relationships *GetTagResponseCollectionDataInnerAllOfRelationships `json:"relationships,omitempty"`
}

type _GetTagResponseCollectionDataInner GetTagResponseCollectionDataInner
...
func NewGetTagResponseCollectionDataInner(type_ TagEnum, id string, attributes TagResponseObjectResourceAttributes, links ObjectLinks) *GetTagResponseCollectionDataInner {
	this := GetTagResponseCollectionDataInner{}
	this.Type = type_
	this.Id = id
...
func (o *GetTagResponseCollectionDataInner) GetRelationships() GetTagResponseCollectionDataInnerAllOfRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret GetTagResponseCollectionDataInnerAllOfRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given GetTagResponseCollectionDataInnerAllOfRelationships and assigns it to the Relationships field.
func (o *GetTagResponseCollectionDataInner) SetRelationships(v GetTagResponseCollectionDataInnerAllOfRelationships) {
	o.Relationships = &v
}

func (o GetTagResponseCollectionDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTagResponseCollectionDataInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetTagResponseCollectionDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTagResponseCollectionDataInner := _GetTagResponseCollectionDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTagResponseCollectionDataInner)

	if err != nil {
		return err
	}

	*o = GetTagResponseCollectionDataInner(varGetTagResponseCollectionDataInner)

	return err
}

type NullableGetTagResponseCollectionDataInner struct {
	value *GetTagResponseCollectionDataInner
	isSet bool
}

func (v NullableGetTagResponseCollectionDataInner) Get() *GetTagResponseCollectionDataInner {
	return v.value
}

func (v *NullableGetTagResponseCollectionDataInner) Set(val *GetTagResponseCollectionDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTagResponseCollectionDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTagResponseCollectionDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTagResponseCollectionDataInner(val *GetTagResponseCollectionDataInner) *NullableGetTagResponseCollectionDataInner {
	return &NullableGetTagResponseCollectionDataInner{value: val, isSet: true}
}

func (v NullableGetTagResponseCollectionDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTagResponseCollectionDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
