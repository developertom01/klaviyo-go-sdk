...
// checks if the SegmentRetrieveResponseObjectResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentRetrieveResponseObjectResource{}

// SegmentRetrieveResponseObjectResource struct for SegmentRetrieveResponseObjectResource
...
type _SegmentRetrieveResponseObjectResource SegmentRetrieveResponseObjectResource
...
func NewSegmentRetrieveResponseObjectResource(type_ SegmentEnum, id string, attributes SegmentListResponseObjectResourceAttributes, links ObjectLinks) *SegmentRetrieveResponseObjectResource {
	this := SegmentRetrieveResponseObjectResource{}
	this.Type = type_
	this.Id = id
...
func (o SegmentRetrieveResponseObjectResource) MarshalJSON() ([]byte, error) {
...
func (o SegmentRetrieveResponseObjectResource) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentRetrieveResponseObjectResource) UnmarshalJSON(data []byte) (err error) {
	...
	varSegmentRetrieveResponseObjectResource := _SegmentRetrieveResponseObjectResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSegmentRetrieveResponseObjectResource)

	if err != nil {
		return err
	}

	*o = SegmentRetrieveResponseObjectResource(varSegmentRetrieveResponseObjectResource)

	return err
}

type NullableSegmentRetrieveResponseObjectResource struct {
	value *SegmentRetrieveResponseObjectResource
	isSet bool
}

func (v NullableSegmentRetrieveResponseObjectResource) Get() *SegmentRetrieveResponseObjectResource {
	return v.value
}

func (v *NullableSegmentRetrieveResponseObjectResource) Set(val *SegmentRetrieveResponseObjectResource) {
	v.value = val
	v.isSet = true
}

func (v NullableSegmentRetrieveResponseObjectResource) IsSet() bool {
	return v.isSet
}

func (v *NullableSegmentRetrieveResponseObjectResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSegmentRetrieveResponseObjectResource(val *SegmentRetrieveResponseObjectResource) *NullableSegmentRetrieveResponseObjectResource {
	return &NullableSegmentRetrieveResponseObjectResource{value: val, isSet: true}
}

func (v NullableSegmentRetrieveResponseObjectResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSegmentRetrieveResponseObjectResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
