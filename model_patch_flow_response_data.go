...
// checks if the PatchFlowResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchFlowResponseData{}

// PatchFlowResponseData struct for PatchFlowResponseData
type PatchFlowResponseData struct {
...
type _PatchFlowResponseData PatchFlowResponseData
...
func (o PatchFlowResponseData) MarshalJSON() ([]byte, error) {
...
func (o PatchFlowResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *PatchFlowResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchFlowResponseData := _PatchFlowResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPatchFlowResponseData)

	if err != nil {
		return err
	}

	*o = PatchFlowResponseData(varPatchFlowResponseData)

	return err
}

type NullablePatchFlowResponseData struct {
	value *PatchFlowResponseData
	isSet bool
}

func (v NullablePatchFlowResponseData) Get() *PatchFlowResponseData {
	return v.value
}

func (v *NullablePatchFlowResponseData) Set(val *PatchFlowResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchFlowResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchFlowResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchFlowResponseData(val *PatchFlowResponseData) *NullablePatchFlowResponseData {
	return &NullablePatchFlowResponseData{value: val, isSet: true}
}

func (v NullablePatchFlowResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchFlowResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
