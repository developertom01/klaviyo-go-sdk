...
// checks if the CouponCodeCreateJobResponseObjectResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponCodeCreateJobResponseObjectResource{}

// CouponCodeCreateJobResponseObjectResource struct for CouponCodeCreateJobResponseObjectResource
...
type _CouponCodeCreateJobResponseObjectResource CouponCodeCreateJobResponseObjectResource
...
func NewCouponCodeCreateJobResponseObjectResource(type_ CouponCodeBulkCreateJobEnum, id string, attributes CouponCodeCreateJobResponseObjectResourceAttributes, links ObjectLinks) *CouponCodeCreateJobResponseObjectResource {
	this := CouponCodeCreateJobResponseObjectResource{}
	this.Type = type_
	this.Id = id
...
func (o CouponCodeCreateJobResponseObjectResource) MarshalJSON() ([]byte, error) {
...
func (o CouponCodeCreateJobResponseObjectResource) ToMap() (map[string]interface{}, error) {
...
func (o *CouponCodeCreateJobResponseObjectResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCouponCodeCreateJobResponseObjectResource := _CouponCodeCreateJobResponseObjectResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCouponCodeCreateJobResponseObjectResource)

	if err != nil {
		return err
	}

	*o = CouponCodeCreateJobResponseObjectResource(varCouponCodeCreateJobResponseObjectResource)

	return err
}

type NullableCouponCodeCreateJobResponseObjectResource struct {
	value *CouponCodeCreateJobResponseObjectResource
	isSet bool
}

func (v NullableCouponCodeCreateJobResponseObjectResource) Get() *CouponCodeCreateJobResponseObjectResource {
	return v.value
}

func (v *NullableCouponCodeCreateJobResponseObjectResource) Set(val *CouponCodeCreateJobResponseObjectResource) {
	v.value = val
	v.isSet = true
}

func (v NullableCouponCodeCreateJobResponseObjectResource) IsSet() bool {
	return v.isSet
}

func (v *NullableCouponCodeCreateJobResponseObjectResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCouponCodeCreateJobResponseObjectResource(val *CouponCodeCreateJobResponseObjectResource) *NullableCouponCodeCreateJobResponseObjectResource {
	return &NullableCouponCodeCreateJobResponseObjectResource{value: val, isSet: true}
}

func (v NullableCouponCodeCreateJobResponseObjectResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouponCodeCreateJobResponseObjectResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
