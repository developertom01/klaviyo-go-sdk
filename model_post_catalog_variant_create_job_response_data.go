...
// checks if the PostCatalogVariantCreateJobResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCatalogVariantCreateJobResponseData{}

// PostCatalogVariantCreateJobResponseData struct for PostCatalogVariantCreateJobResponseData
type PostCatalogVariantCreateJobResponseData struct {
...
type _PostCatalogVariantCreateJobResponseData PostCatalogVariantCreateJobResponseData
...
func NewPostCatalogVariantCreateJobResponseData(type_ CatalogVariantBulkCreateJobEnum, id string, attributes CouponCodeCreateJobResponseObjectResourceAttributes, links ObjectLinks) *PostCatalogVariantCreateJobResponseData {
	this := PostCatalogVariantCreateJobResponseData{}
	this.Type = type_
	this.Id = id
...
func (o PostCatalogVariantCreateJobResponseData) MarshalJSON() ([]byte, error) {
...
func (o PostCatalogVariantCreateJobResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *PostCatalogVariantCreateJobResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCatalogVariantCreateJobResponseData := _PostCatalogVariantCreateJobResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCatalogVariantCreateJobResponseData)

	if err != nil {
		return err
	}

	*o = PostCatalogVariantCreateJobResponseData(varPostCatalogVariantCreateJobResponseData)

	return err
}

type NullablePostCatalogVariantCreateJobResponseData struct {
	value *PostCatalogVariantCreateJobResponseData
	isSet bool
}

func (v NullablePostCatalogVariantCreateJobResponseData) Get() *PostCatalogVariantCreateJobResponseData {
	return v.value
}

func (v *NullablePostCatalogVariantCreateJobResponseData) Set(val *PostCatalogVariantCreateJobResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCatalogVariantCreateJobResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCatalogVariantCreateJobResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCatalogVariantCreateJobResponseData(val *PostCatalogVariantCreateJobResponseData) *NullablePostCatalogVariantCreateJobResponseData {
	return &NullablePostCatalogVariantCreateJobResponseData{value: val, isSet: true}
}

func (v NullablePostCatalogVariantCreateJobResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCatalogVariantCreateJobResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
