...
// checks if the GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner{}

// GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner struct for GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner
type GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner struct {
...
type _GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner
...
func NewGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner(type_ CatalogCategoryBulkCreateJobEnum, id string, attributes CouponCodeCreateJobResponseObjectResourceAttributes, links ObjectLinks) *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner {
	this := GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner{}
	this.Type = type_
	this.Id = id
...
func (o GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner := _GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner)

	if err != nil {
		return err
	}

	*o = GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner(varGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner)

	return err
}

type NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner struct {
	value *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner
	isSet bool
}

func (v NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) Get() *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner {
	return v.value
}

func (v *NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) Set(val *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner(val *GetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) *NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner {
	return &NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner{value: val, isSet: true}
}

func (v NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCatalogCategoryCreateJobResponseCollectionCompoundDocumentDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
